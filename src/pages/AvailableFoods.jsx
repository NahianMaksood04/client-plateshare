...
const AvailableFoods = () => {
    ...
    const filteredAndSortedFoods = useMemo(() => {
        ...
        if (sortOption === 'expireDate') {
            processedFoods.sort((a, b) => new Date(a.expiredDateTime) - new Date(b.expiredDateTime));
    ...
    return (
        <div className="container mx-auto px-4 py-16">
            <div className="text-center mb-12">
                ...
                <p className="mt-2 text-lg text-neutral/70">Search, sort, and discover food shared by the community.</p>
            </div>
