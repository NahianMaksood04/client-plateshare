...
mutationFn: async (id) => (await api.delete(/api/foods/${id})).data,
onSuccess: () => {
...
<td>
<span className={badge ${f.food_status === 'Available' ? 'badge-success' : 'badge-neutral'}}>{f.food_status}</span>
</td>
...
{data?.length === 0 && (
<tr>
<td colSpan={6} className="text-center py-6 text-neutral/70">You have not added any foods yet.</td>
</tr>
)}
</tbody>
</table>
